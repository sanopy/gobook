...
func TestEqual(t *testing.T) {
	...
	for _, test := range []struct {
		...
		{0.1, 0.15, false},
		{1 * 1e-9, 2 * 1e-9, false},
		{1 * 1e-10, 2 * 1e-10, true},
		// complex
		{complex(1, 1), complex(1, 1), true},
		{complex(1, 1), complex(1, 2), false},
		{complex(1*1e-9, 1), complex(2*1e-9, 1), false},
		{complex(1*1e-10, 1), complex(2*1e-10, 1), true},
		// slices
		{[]string{"foo"}, []string{"foo"}, true},
		{[]string{"foo"}, []string{"bar"}, false},
		{[]string{}, []string(nil), true},
		{[]float64{1, 2, 1 * 1e-9}, []float64{1, 2, 2 * 1e-9}, false},
		{[]float64{1, 2, 1 * 1e-10}, []float64{1, 2, 2 * 1e-10}, true},
		// slice cycles
